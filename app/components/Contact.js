            ...
            <Grid item xs={12} md={6} lg={6}>
              <div className="text-[#ABB2BF] font-normal text-base flex flex-col gap-7">
                <p>
                  ...
                  collaboration opportunities, or freelance work. I&apos;m
                  always excited to connect and explore new possibilities in the
                  world of web development and technology.
                </p>
                <p>
                  Your feedback is invaluable to me, as it helps me refine my
                  skills and deliver better solutions. If you&apos;re looking
                  for a passionate and skilled full-stack web app developer to
                  join your team or collaborate on a project, don&apos;t
                  hesitate to reach out. Let&apos;s work together to create
